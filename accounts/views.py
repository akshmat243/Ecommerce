...
from accounts.models import UserRole, UserProfile, Address
from accounts.serializers import UserSerializer, RegisterUserSerializer, UserRoleSerializer, UserProfileSerializer, AddressSerializer
...
class AddressViewSet(ProtectedModelViewSet):
...
class UserProfileViewSet(ProtectedModelViewSet):
